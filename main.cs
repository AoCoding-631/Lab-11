...
class MainClass {
  public static void Main (string[] args) {
    ...
    Console.WriteLine("Faculty Member");
    Faculty m1 = new Faculty("Asmah", "Shaheed");
    m1.DateOfEmployment = Convert.ToDateTime("01/01/1997");
    m1.YearlySalary = 80000;
    m1.Tenured = true;
    m1.Id = "3749633";
    m1.Intro();
    m1.Promote();
    //m1.GrandTenure();
    bool Tenured = m1.GrandTenure();
  }
}